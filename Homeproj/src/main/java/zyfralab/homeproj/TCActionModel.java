...
public class TCActionModel extends DefaultTableModel
{
        ...
        public class TCActionListener implements TableModelListener
        {
            
            public TCActionListener() {
            }
                ...
                try 
                {
                  //  String colName = getColumnName(col);
                    ...
                    switch(col)
                    {
                        ...
                        case 4:
                            intVal = (int)data;
                            dbStore.TCActionDB_changeData(intVal,row,col);
                            break;
                        case 3:
                            strVal = (String)data;
                            dbStore.TCActionDB_changeData(strVal, row, col);
                            break;
                        case 5:
                            flVal = (float)data;
                            dbStore.TCActionDB_changeData(flVal,row, col);
                    }
        ...
        public TCActionModel(Reporter rep) {
              repo = rep;
      ...
      //      dbStore.openConn();
        ...
        public void initModel() {
            try {
                updateTable();                             
                TCActionListener tckeLis = new TCActionListener(); 
        ...
        public void updateTable() {       
            try {
               ...
               // ResultSetMetaData metaData = rs.getMetaData();
                int numberOfColumns = dbStore.getActionDB_columns(); //metaData.getColumnCount();
                if (columnNames==null) 
            ...
            try {
                ...
                while (dbStore.next())
                {
                    ...
                    for (int i=0; i<colCount; i++)
                    {
                            ...
                            Object obj = dbStore.TCActionDB_getObject(i);
                            newRow.add(obj);
                    }
                    rows.add(newRow);  
                }            
